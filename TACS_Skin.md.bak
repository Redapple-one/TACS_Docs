...
<img src="./assets/register.png" alt="注册页面" width="400"/>
...
<img src="./assets/email.png" alt="“验证你的邮箱地址”" width="400"/>

你可能需要打开 [QQ 邮箱](https://mail.qq.com)并登录，查看收件箱或垃圾/骚扰邮件，寻找一封类似这样的邮件并打开：

<img src="./assets/qq_email.png" alt="验证邮件" width="400"/>

打开后你会看到类似的邮件内容：

<img src="./assets/venify_email.png" alt="验证邮件链接" width="600"/>

点击邮件中的链接，你会看到：

<img src="./assets/venify_email2.png" alt="填写验证邮箱" width="600"/>
